...
const std::array<uint64_t, 64> ROOK_MAGICS = {
    0x80024000802910,   0x100100821004040,  0x80a000a004840008, 0x2c08000420802008,
    0x220004a108140200, 0x220004a108140200, 0x220004a108140200, 0x1000080644a0100,
    0x491101020804000,  0x2000402914c0800,  0x8001201800402260, 0x100888002330004,
    0x1012482010080080, 0xa80042100c010,    0x880804204004140,  0x8a0800080004229,
    0x2040a0a001001140, 0x4000600a002000,   0x880602004450158,  0x4001248009000,
    0x4001120011300a00, 0x100888002330004,  0x5020018004044122, 0x940801001020,
    0x240010c8400400e0, 0x240001902028088,  0x101020005408,     0x1800022444002100,
    0x101022002004810,  0x1820080050400,    0x90104012800a0003, 0x800804c0026480,
    0x80802010002009a0, 0x120005644284000,  0x2040842000411,    0x2040842000411,
    0x2040842000411,    0x2040842000411,    0x100888002330004,  0x2e508c480c020402,
    0x8002004000860800, 0x2020134002042200, 0x5200109200208,    0x4001248009000,
    0xc222200100202008, 0x41004004424a0802, 0x100888002330004,  0x120400050a80500,
    0x24802290410100,   0x3a00802502504e0,  0x420010a11820c420, 0x880804204004140,
    0x880804204004140,  0x204000282190220,  0x21200380410,      0x404020940082c020,
    0x22100884288220a,  0x2801209200205642, 0x104420008208012,  0x42002824121042,
    0x8001004010059,    0x1300800cc000101,  0x10010028105420c,  0x1000010020c28412,
};
...
[[nodiscard]] inline uint64_t get_queen_attacks_direct(Square square, uint64_t blockers) {
    return (
        get_bishop_attacks_direct(square, blockers) | get_rook_attacks_direct(square, blockers)
    );
}
...
extern void generate_piece_targets(
    MoveList& move_list, const Position& position, F get_attacks, bool include_quiets
);
